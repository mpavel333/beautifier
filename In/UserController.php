    ...
    public function behaviors()
    {
        return [
            ...
            'role' => [
                ...
                'instanceQuery' => \app\models\User::find(),
                'actions' => [
                    'create' => 'settingsGlob',
                    'update' => 'settingsGlob',
                    'view' => 'settingsGlob',
            ...
            if ($request->isGet) {
                return [
                    ...
                    'footer' => Html::button('Cancel',
                        ...
                        Html::button('Create', ['class' => 'btn btn-primary btn-sm', 'type' => "submit"])
                ...
                if ($model->load($request->post()) && $model->save()) {
                    ...
                    return [
                        'forceReload' => '#crud-datatable-pjax',
                        'title' => "Create user",
                        'content' => '<span class="text-success">Create user successfully</span>',
