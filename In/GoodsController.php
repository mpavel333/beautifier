    ...
    public function behaviors()
    {
        ...
        return [
            ...
            'access' => [
                ...
                'except' => ['application-form', 'export-data-xml-avito'],
                'rules' => [
                    [
                        'allow' => true,
   ...
   /**
    ...
    {    
        ...
        if($role && $role->enabled_good_statuses){
            ...
            $dataProvider->query->andWhere(['status_id' => explode(',', $role->enabled_good_statuses)]);
        }
    ...
    public function actionMassiveStatus($pks, $pjax = '#crud-datatable-goods') 
    {
        ...
        if($request->isGet){
            return [
                    ...
                    'content'=>$this->renderAjax('status', ['pks' => $pks]),
                    'footer'=> Html::button(\Yii::t('app', 'Отмена'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                                Html::button(\Yii::t('app', 'Готово'),['class'=>'btn btn-primary','type'=>"submit"])
...
\Yii::warning($row);
                    ...
                    return [
                        'forceReload'=>'#crud-datatable-goods',
                        'title'=> "Загружения",
                ...
                return [
                    ...
                    'size'=>'normal',
                    'content'=>$this->renderAjax('_my_import', [
                        'model' => $model,
                    ]),
    ...
    {
        Yii::$app->session->set('goods-form-session', \yii\helpers\ArrayHelper::getValue($_POST, 'Goods'));
    }
...
/**
    ...
    public function actionExportDataXmlAvito()
    {
        ...
        $dataProvider->query->andWhere(['is_avito' => true]);
        ...
        $xmlContent = $this->renderPartial('_export_avito', [
            'models' => $models,    
        ]);
        ...
        Yii::$app->response->sendFile('data.xml');
    }
    ...
    {
        $goods = \app\models\Goods::find()->where(['and', ['is not', 'files', null], ['!=', 'files', '']])->all();
    ...
    public function actionCreateStatus($myRoute = "goods", $update=null, $id = null)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                if ($id) {
                    Yii::$app->session->set('route-session-update', $id);
                }
                if(Yii::$app->session->has('route-session')){
                    $r = Yii::$app->session->get('route-session');
                    $r[] = $myRoute;
                    Yii::$app->session->set('route-session', $r);
                } else {
                    $r[] = $myRoute;
                    Yii::$app->session->set('route-session', $r);
                }
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Статусы товара"),
                    'content'=>$this->renderAjax($viewLink, [
                        'model' => $model,
                        'action' => "/goods/create-status",
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                        Html::a(\Yii::t('app', 'Назад'), '/goods/create', ['class'=>'btn btn-warning','role' => 'modal-remote',]).
                        Html::button(\Yii::t('app', 'Добавить'),['class'=>'btn btn-primary','type'=>"submit"])
                ...
                if(Yii::$app->session->has('route-session')){
                    ...
                    \Yii::warning($newR);
                    if (count($newR) > 0) {
                        Yii::$app->session->set('route-session', $newR);
                        $action = "/{$lastRo}/create-{$myRoute}";
                    } else {
                        if(Yii::$app->session->has('route-session-update')){
                            $id = Yii::$app->session->get('route-session-update');
                        }
                ...
                if(Yii::$app->session->has('goods-form-session')){
                    $origin->attributes = Yii::$app->session->get('goods-form-session');
                }
                $origin->status_id = $model->id;

                return [
                    'title'=> \Yii::t('app', "Добавить Товары"),
                    'content'=>$this->renderAjax($id ? '_form' : '_form', [
                        'model' => $origin,
                        'action' => $action,
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Статусы товара"),
                    'content'=>$this->renderAjax('@app/views/status/create', [
                        'model' => $model,
                        'action' => $action,
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                ...
                return $this->render('@app/views/status/create', [
                    'model' => $model,
                ]);
            }
        }
...
/**
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'content'=>$this->renderAjax($viewLink, [
                        'model' => $model,
                        'action' => "/goods/create-status-repair",
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                        Html::a(\Yii::t('app', 'Назад'), '/goods/create', ['class'=>'btn btn-warning','role' => 'modal-remote',]).
                        Html::button(\Yii::t('app', 'Добавить'),['class'=>'btn btn-primary','type'=>"submit"])
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Статусы товара"),
                    'content'=>$this->renderAjax('@app/views/status-repair/create', [
                        'model' => $model,
                        'action' => $action,
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                ...
                return $this->render('@app/views/status-repair/create', [
                    'model' => $model,
                ]);
            }
        }
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Категория"),
                    'content'=>$this->renderAjax($viewLink, [
                        'model' => $model,
                        'action' => "/goods/create-manufacturer",
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                        Html::a(\Yii::t('app', 'Назад'), '/goods/create', ['class'=>'btn btn-warning','role' => 'modal-remote',]).
                        Html::button(\Yii::t('app', 'Добавить'),['class'=>'btn btn-primary','type'=>"submit"])
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Категория"),
                    'content'=>$this->renderAjax('@app/views/manufacturer/create', [
                        'model' => $model,
                        'action' => $action,
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                ...
                return $this->render('@app/views/manufacturer/create', [
                    'model' => $model,
                ]);
            }
        }
    ...
    public function actionCheckBySerial($id)
    {
        ...
        if(\Yii::$app->request->isGet){
            return [
                'title'=> \Yii::t('app', "Серийный номер"),
                'content'=>$this->renderAjax('check-by-serial', [
                    'error' => false,
                    'model' => $model,
                ]),
                'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            if($model->serial === $serial){
               $order = new \app\models\Order(['tovar_id' => $id, 'status_id' => 2]);
                ...
                return [
                    ...
                    'content'=>$this->renderAjax('@app/views/order/_form', [
                        'model' => $order,
                        'action' => 'create',
                        'formUrl' => ['/order/create', 'pjax' => '#crud-datatable-goods-container', 'clouse' => true],
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Отмена'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                                Html::button(\Yii::t('app', 'Создать'),['class'=>'btn btn-primary','type'=>"submit"])
                ]; 
    ...
    public function actionExportData()
    {
        ...
        if(\Yii::$app->request->isGet){
            return [
                'title'=> \Yii::t('app', "Добавить Брэнд"),
                'content'=>$this->renderAjax('export-form', [
                ]),
                'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                    Html::button(\Yii::t('app', 'Далее'),['class'=>'btn btn-primary','type'=>"submit"])
            ];
        } elseif(\Yii::$app->request->isPost){
            ...
            return [
                'title'=> \Yii::t('app', "Добавить Брэнд"),
                'content'=> \yii\helpers\Html::a('Скачать Excel', \yii\helpers\ArrayHelper::merge(['goods/export-data-exec', 'attrs' => $attributes, 'condit_price_percent' => $condit_price_percent], Yii::$app->request->queryParams), ['class' => 'btn btn-success btn-sm btn-block', 'data-pjax' => 0]),
                'footer'=> '',
            ];
        }
    }
...
/**
    ...
    public function actionExportDataXml()
    {
        ...
        $xmlContent = $this->renderPartial('_export_xml', [
            'models' => $models,    
        ]);
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Брэнд"),
                    'content'=>$this->renderAjax('@app/views/brand/create', [
                        'model' => $model,
                        'action' => $action,
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                ...
                return $this->render('@app/views/brand/create', [
                    'model' => $model,
                ]);
            }
        }
    ...
    {   
        ...
        $orderDataProvider->query->andWhere(['tovar_id' => $id]);
            $paySearchModel = new \app\models\PaySearch();
        $payDataProvider = $paySearchModel->search(Yii::$app->request->queryParams);
        $payDataProvider->query->andWhere(['tovar_id' => $id]);
            $logsSearchModel = new \app\models\LogsSearch();
        $logsDataProvider = $logsSearchModel->search(Yii::$app->request->queryParams);
        $logsDataProvider->query->andWhere(['good_id' => $id]);
        ...
        if($request->isAjax){
			...
			'paySearchModel'=>$paySearchModel,
			'payDataProvider'=>$payDataProvider,
			'logsSearchModel'=>$logsSearchModel,
    ...
    public function actionCreate($pjax = '#crud-datatable-goods', $clouse = false, $atr = null, $value = null) 
    {
        $request = Yii::$app->request;
        $model = new Goods();
        Yii::$app->session->remove('route-session-update');
        if(Yii::$app->session->has('route-session')){
            Yii::$app->session->remove('route-session');
        }
        if(Yii::$app->session->has('goods-form-session')){
            $model->attributes = Yii::$app->session->get('goods-form-session');
        }
        if($request->isGet){
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                Yii::$app->session->remove('goods-form-session');
                
                return $this->redirect(['/order']);                if ($clouse) {
                    return [
                        'forceReload'=> $pjax,
                        'forceClose' => true,
                    ];
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Комплектующие"),
                    'content'=>$this->renderAjax($viewLink, [
                        'model' => $model,
                        'action' => "/goods/create-storage",
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                        Html::a(\Yii::t('app', 'Назад'), '/goods/create', ['class'=>'btn btn-warning','role' => 'modal-remote',]).
                        Html::button(\Yii::t('app', 'Добавить'),['class'=>'btn btn-primary','type'=>"submit"])
                ...
                return [
                    'title'=> \Yii::t('app', "Добавить Комплектующие"),
                    'content'=>$this->renderAjax('@app/views/storage/create', [
                        'model' => $model,
                        'action' => $action,
                    ]),
                    'footer'=> Html::button(\Yii::t('app', 'Закрыть'),['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            ...
            if ($model->load($request->post()) && $model->save()) {
                ...
                return $this->render('@app/views/storage/create', [
                    'model' => $model,
                ]);
            }
        }
